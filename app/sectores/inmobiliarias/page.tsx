  ...
  return (
    ...
    <Header />
      <HeroSection
        ...
        subtitle="Mejora la captación de clientes, agendamiento de visitas y seguimiento de operaciones con nuestros scouts de IA."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Transforma tu inmobiliaria con IA</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Calificación automática de leads</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Agendamiento inteligente de visitas</h3>
                    <p className="text-gray-600">
                      Coordina visitas a propiedades según la disponibilidad de tus agentes y envía recordatorios
                      automáticos.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Seguimiento personalizado de clientes</h3>
                    <p className="text-gray-600">
                      Mantén el contacto con tus clientes potenciales mediante seguimientos automáticos y
                      personalizados.
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-10">
                <CTAButton text="Potencia tu inmobiliaria" />
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 flex justify-center">
              <div className="relative h-[400px] w-[400px]">
                <Image
                  src="/inmo.png?height=400&width=400"
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="bg-white border rounded-xl p-8 max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold mb-6 text-center">Caso de éxito: Lopez Inmobiliaria</h2>
            ...
            <div className="flex items-center">
              <div className="relative h-12 w-12 rounded-full overflow-hidden mr-4">
                <Image src="/diego-inmo.jpg?height=48&width=48" alt="Testimonio" fill className="object-cover" />
              </div>
              <div>
                <p className="font-semibold">Diego Lopez</p>
                <p className="text-sm text-gray-600">Director, Lopez Inmobiliaria </p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-8">¿Listo para transformar tu inmobiliaria?</h2>

...
export function Hero() {
  // Efecto para la animación del borde brillante
  useEffect(() => {
  ...
  return (
    <section className="relative pt-32 pb-24 px-4 overflow-hidden">
      ...
      <div className="container mx-auto text-center max-w-4xl relative z-10">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 text-[#0071E3]">Optimiza tu equipo con Bravilo Scouts</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Automatiza y optimiza tus tareas repetitivas, mejora la gestión de talento y libera el potencial de tu equipo
          con nuestros scouts de IA.
        </p>
  ...
  {/* <Button variant="outline" className="text-lg px-8 py-6 border-[#0071E3] text-[#0071E3]">
    Ver demo
  </Button> */}
</div>
        ...
        <div className="relative mx-auto max-w-6xl mt-20 mb-[-120px]">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(90deg, transparent 20%, rgba(0,113,227,0.2) 50%, transparent 80%)",
